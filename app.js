...
function renderPetResults(result) {
    if (result === undefined) {
        ...
        <figure>
        <img src="project_paws/images/chief_sleeping.jpg" alt="Chief sleeping from Instagram @chiefandzoe" />
...
function displayImages(result) {
    if(!result.media || !result.media.photos) {
        return `<figure>
        <img src="project_paws/images/zoe_no_image.jpg" alt="no image available" />
